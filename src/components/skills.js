  ...
  return (
    <div id="skills">
      <ul id="skills-list">
        ...
        <li><p>CSS - 50%</p><span className="bar"><span className="css"></span></span></li>
        ...
        <li><p>JQUERY - 50%</p><span className="bar"><span className="jquery"></span></span></li>
        <li><p>NODEJS - 60%</p><span className="bar"><span className="nodejs"></span></span></li>
        <li><p>GRAPHQL - 70%</p><span className="bar"><span className="graphql"></span></span></li>
      </ul>
    </div>
  );
};
